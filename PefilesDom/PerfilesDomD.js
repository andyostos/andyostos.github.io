...
const baseDeDatos = [
    ...
    const nArtista = baseDeDatos.find(objeto => objeto.id === 5);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const nImagen = baseDeDatos.find(objeto => objeto.id === 5);
 ...
 //NombreProducto
    ...
    // Buscar el objeto con id=1 (Vasili)
    const nSemblanza = baseDeDatos.find(objeto => objeto.id === 5);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const npasionA = baseDeDatos.find(objeto => objeto.id === 5);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const npasionB = baseDeDatos.find(objeto => objeto.id === 5);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const npasionC = baseDeDatos.find(objeto => objeto.id === 5);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const npasionD = baseDeDatos.find(objeto => objeto.id === 5);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const nNombreFoto = baseDeDatos.find(objeto => objeto.id === 5);

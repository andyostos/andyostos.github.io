document.addEventListener('DOMContentLoaded', () => {
...

    {
        ...
        nombre: 'La Piedad',
        precio: 500,
        imagen:'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Michelangelo%27s_Pieta_5450_cropncleaned.jpg/1200px-Michelangelo%27s_Pieta_5450_cropncleaned.jpg',
        Existencia: 'TRUE',
        Categoria: 'Escultura',
    ...
    const nProducto = baseDeDatos.find(objeto => objeto.id === 8);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const tipoTec = baseDeDatos.find(objeto => objeto.id === 8);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const nArtista = baseDeDatos.find(objeto => objeto.id === 8);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const nPrecio = baseDeDatos.find(objeto => objeto.id === 8);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const dObra = baseDeDatos.find(objeto => objeto.id === 8);
    ...
    //Imagen
        ...
        const eImagen = baseDeDatos.find(objeto => objeto.id === 8);

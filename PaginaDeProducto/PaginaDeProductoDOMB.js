document.addEventListener('DOMContentLoaded', () => {
    ...
    const nProducto = baseDeDatos.find(objeto => objeto.id === 3);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const tipoTec = baseDeDatos.find(objeto => objeto.id === 3);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const nArtista = baseDeDatos.find(objeto => objeto.id === 3);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const nPrecio = baseDeDatos.find(objeto => objeto.id === 3);
    ...
    // Buscar el objeto con id=1 (Vasili)
    const dObra = baseDeDatos.find(objeto => objeto.id === 3);
    ...
    //Imagen
        ...
        const eImagen = baseDeDatos.find(objeto => objeto.id === 3);
